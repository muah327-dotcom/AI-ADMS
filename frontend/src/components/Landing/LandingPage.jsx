      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen flex items-center">
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full py-12">
          ...
          >
            <motion.div 
              variants={fadeInUp}
              className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-100 text-cyan-700 rounded-full text-sm font-medium mb-6"
            >
              <Sparkles className="w-4 h-4" />
              AI-Enhanced Admission System
            </motion.div>
  ...
  const solutions = [
    {
      ...
      description: "Upload your documents once, and let AI extract and fill your data automatically. No more manual typing!",
          ...
          {solutions.map((solution, index) => (
            ...
            >
              ...
              <motion.div variants={index % 2 === 0 ? slideInRight : slideInLeft}>
                <span className="inline-flex items-center gap-1 px-3 py-1 bg-cyan-100 text-cyan-700 rounded-full text-xs font-medium mb-4">
